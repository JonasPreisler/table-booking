module Api
  module V1
    class GuestsController < ApplicationController
      ...
      def guest_params
        params.permit(:guest, :guestlist_id, :first_name, :last_name, :gender, :event_id, :guestlist, :ambassador_id, :ambassador_name, :event_id, :ambassador, :unprocessable_entity)
      end
    end
  end
end