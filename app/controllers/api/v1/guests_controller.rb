    ...
    class GuestsController < ApplicationController
      ...
      def create
        ...
        if guest.save
          ...
          data:guest.errors.full_messages},status: :unprocessable_entity
        end
      end
      ...
      def guest_params
        params.permit(:guest, :guestlist_id, :first_name, :last_name, :gender, :event_id, :guestlist, :ambassador_id, :ambassador_name, :event_id, :ambassador, :full_messages, :error, :errors, :status)
      end
    end
  end
end